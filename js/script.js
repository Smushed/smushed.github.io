...
function bootTerminal() {
    ...
    messages.forEach((msg, index) => {
        ...
        }, index * 50); // Faster boot for terminal
    });
...
function executeCommand(command) {
    ...
    switch (cmd) {
        ...
        case "resume":
            ...
            setTimeout(() => {
                window.open(
                    "./assets/resume/Kevin Flerlage Resume.pdf",
                    "_blank",
                );
        ...
        case "cls":
            output.innerHTML = "";
            // Re-add welcome message if cleared? Maybe not, keep it clean.
            break;
    ...
    function processNextLine() {
        ...
        const typeInterval = setInterval(() => {
            ...
            if (charIndex >= text.length) {
                ...
                lineIndex++;
                setTimeout(processNextLine, 50); // Small pause between lines
            }
...
function runHackSequence() {
    ...
    setTimeout(() => {
        ...
        const hexInterval = setInterval(() => {
            ...
            line.textContent = `0x${Math.floor(
                Math.random() * 1000000,
            ).toString(16)}: ${hex} ${hex}`;
            output.appendChild(line);
            output.scrollTop = output.scrollHeight;
